...
<head>
  ...
  <title>Grosirku | Penjual</title>
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet"
    integrity="sha384-T3c6CoIi6uLrA9TneNEoa7RxnatzjcDSCmG1MXxSR1GAsXEV/Dwwykc2MPK8M2HN" crossorigin="anonymous">
  <link rel="stylesheet" href="/resource/style-statusbarang.css">
</head>
...
<body>
  ...
  <div class="header-dropdown">
    <div class="menu-dropdown" id="dropdown-content">
      <nav>
        <u class="nav-link">
          <li><a id="shaking" href="enjual">Beranda</a></li>
  ...
  <div class="body-container">
    <div class="container">
      <div class="filter-table">
        <h5>Filter :</h5>
        <select name="" id="">
          <option value="">Sedang dijual</option>
      ...
      <table class="table">
        <thead>
          <tr>
            ...
            <th class="col">Terjual</th>
            <th class="col">Harga</th>
            <th class="col">Alamat</th>
            <th class="col">Nama Penyedia</th>
            <th class="col">Tanggal Penempatan</th>
