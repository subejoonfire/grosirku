    ...
    <div class="body-container">
      <div class="containers">
        <div class="leftside-container">
          <div class="add-data">
            <h2>Tambah Data Penyedia</h2>
            <form action="/tambahPenyedia" method="post">
        ...
        <div class="table-container">
          <table>
            ...
            <tbody>
              ...
              $data = $penyediaModel->get()->getResult();
              foreach ($data as $row) :
              ?>
                <tr>
                  <td scope="row"><?= $row->idpenyedia ?></td>
                  <td><?= $row->pyusername ?></td>
                  <td class="aksi">
                    <a href="/editPagePenyedia/<?= $row->idpenyedia ?>" type="button" class="btn btn-success">Edit</a>
                    <a href="/hapusPenyedia/<?= $row->idpenyedia ?>" type="button" class="btn btn-danger">Hapus</a>
                  </td>
                </tr>
              <?php endforeach ?>
            </tbody>
